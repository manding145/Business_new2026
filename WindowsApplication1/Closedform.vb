...
Public Class Closedform
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Try
            ...
            Dim remarkstext As String = txt_remarks.Text


            Con_ms = New SqlConnection(mcs)
            Con_ms.Open()
            conn_ms = "UPDATE ONLINE.business_applicationstatus_dtl set verify_status = 'C', IsReupload ='0', Denied_remarks = @Remarks,  verify_deny_dttime = '" & mytimestamp & "', user_deny='" & userid & "' WHERE applicationID='" & BPLOApplicationRecord.txt_applicationno.Text & "'"
            cmd_ms = New SqlCommand(conn_ms, Con_ms)
            cmd_ms.Parameters.Add("@Remarks", SqlDbType.VarChar).Value = remarkstext
            cmd_ms.ExecuteNonQuery()
            Con_ms.Close()

            MsgBox("Application successully Closed. This client will received notification to his email.", vbOKOnly & vbInformation, "Business Renewal")
            Me.Close()
