...
Public Class SampleMayorsPermit
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.SampleMayorsPermit.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_permitAppID() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedSampleMayorsPermit
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SampleMayorsPermit = New SampleMayorsPermit()
        rpt.Site = Me.Site
        Return rpt
    End Function
