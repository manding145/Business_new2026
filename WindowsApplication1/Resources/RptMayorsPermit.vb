...
Public Class RptMayorsPermit
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WindowsApplication1.RptMayorsPermit.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptMayorsPermit
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptMayorsPermit = New RptMayorsPermit()
        rpt.Site = Me.Site
        Return rpt
    End Function
